...
#define NATIONAL_DEX_EEVEE_P 899
#define NATIONAL_DEX_EEVEE_DRAGON 900
#define NATIONAL_DEX_EEVEE_NORMAL 901
#define NATIONAL_DEX_EEVEE_FIGHTING 902
#define NATIONAL_DEX_EEVEE_FLYING 903
#define NATIONAL_DEX_EEVEE_POISON 904
#define NATIONAL_DEX_EEVEE_GROUND 905
#define NATIONAL_DEX_EEVEE_ROCK 906
#define NATIONAL_DEX_EEVEE_BUG 907
#define NATIONAL_DEX_EEVEE_GHOST 908
#define NATIONAL_DEX_GALVEON 909

#define FINAL_DEX_ENTRY NATIONAL_DEX_GALVEON //Not +1 b/c used like this for some asm
#define NATIONAL_DEX_COUNT NATIONAL_DEX_GALVEON + 1
...
extern const u8 DEX_ENTRY_EEVEE_P[];
extern const u8 DEX_ENTRY_EEVEE_DRAGON[];
extern const u8 DEX_ENTRY_EEVEE_NORMAL[];
extern const u8 DEX_ENTRY_EEVEE_FIGHTING[];
extern const u8 DEX_ENTRY_EEVEE_FLYING[];
extern const u8 DEX_ENTRY_EEVEE_POISON[];
extern const u8 DEX_ENTRY_EEVEE_GROUND[];
extern const u8 DEX_ENTRY_EEVEE_ROCK[];
extern const u8 DEX_ENTRY_EEVEE_BUG[];
extern const u8 DEX_ENTRY_EEVEE_GHOST[];
extern const u8 DEX_ENTRY_GALVEON[];
